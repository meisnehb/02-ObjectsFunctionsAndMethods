...
def main():
    ...
    # even_better_draw_circles(rg.Point(10, 10), 15, 6, 'blue', 5)

    even_better_draw_circles(rg.Point(0, 0), 9, 2, 'red', 10)
    even_better_draw_circles(rg.Point(80, 125), 20, 1, 'black', 5)
    even_better_draw_circles(rg.Point(-80, 125), 20, 1, 'black', 5)
    even_better_draw_circles(rg.Point(-80, 125), 5, 1, 'blue', 10)
    even_better_draw_circles(rg.Point(-80, 125), 5, 1, 'blue', 10)
    even_better_draw_circles(rg.Point(80, 125), 5, 1, 'blue', 10)
    even_better_draw_circles(rg.Point(80, 125), 1, 1, 'black', 10)
    even_better_draw_circles(rg.Point(80, 125), 1, 1, 'black', 10)
    even_better_draw_circles(rg.Point(-80, 125), 1, 1, 'black', 10)
    even_better_draw_circles(rg.Point(0, 75), 150, 1, 'black', 5)
...
def better_draw_circles(point, radiusVariance):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        # Go DOWN radiusVariance pixels, ending up pointing east again
        turtle.right(90)
        turtle.forward(radiusVariance)
        turtle.left(90)

        turtle.pen_down()
        turtle.draw_circle(radiusVariance * k)
...
def even_better_draw_circles(point, radiusVariance, number, color, thickness):
